      ...
      <div className=" rounded-2xl  flex flex-col items-center">
        <div className="w-80 flex items-center sm:w-[600px] md:w-[700px] lg:w-[900px] xl:w-[1100px] rounded-2xl overflow-hidden h-[350px] bg-[url('https://metro.co.uk/wp-content/uploads/2022/08/GettyImages-1344972184-e1661260282529.jpg?quality=90&strip=all&zoom=1&resize=480%2C295')] bg-cover bg-center">
          ...
          <div className=" gap-10 px-3 py-1 w-[200px] xl:w-[400px]  rounded-md text-3xl  flex flex-col justify-center items-center font-medium text-white hover:text-indigo-500m  ml-44 sm:ml-96 md:ml-[450px] lg:ml-[550px] xl:ml-[670px]">
            ...
            <h2 className="text-black  flex flex-col items-center justify-center lg:w-[400px] lg:text-3xl xl:w-[600px] xl:text-4xl">Be a Voice for the Voiceless</h2>
            <Link to="/Report" className="px-3 text-[50px] shadow-2xl shadow-black py-1 rounded-md text-3xl w-[250px] h-[100px] flex justify-center items-center font-medium text-center text-white hover:text-indigo-500m hover:bg-red-500  bg-black">
              Report
            </Link>
          ...
          <div class="py-16 max-w-7xl rounded-2xl px-4 sm:px-6 lg:px-8 bg-gray-400">
            <div class="max-w-7xl mx-auto ">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-gray-50 hover:shadow-2xl hover:shadow-black hover:cursor-pointer p-6 rounded-lg shadow-lg hover:bg-gradient-to-tr hover:from-yellow-300 hover:to-white hover:from-[0%] hover:to-[100%] relative">
                ...
                <div class="bg-gray-50 hover:shadow-2xl hover:shadow-black hover:cursor-pointer p-6 rounded-lg shadow-lg hover:bg-gradient-to-tr hover:from-yellow-300 hover:to-white hover:from-[0%] hover:to-[100%]">
